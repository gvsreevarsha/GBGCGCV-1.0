...
<html>
	...
	<body>
		...
		<table><tr>
		<th><input type="submit" name="sms" class="sms" value="Send SMS"/>
		</th>
			<form class="form-horizontal" action="function1.php" method="post" name="upload_excel" enctype="multipart/form-data">
 
                  <th>     
                        <input type="submit" name="Export" class="btn btn-success" value="Generate Excel"/>
					</th>
            </form>
		</tr>
		</table>	
		 ...
		 <form action="" method="post">
				<div id="s1">Education Filter</div>
						...
						<table style="width: 500px">
							<tr>
									<div id="divcolor">
										<td id="row1" align="left">Degree</td>
										<td id="row1" align="center">Branch</td>
										<td id="row1" align="right">Cgpa</td>
									</div>	
							</tr>
							<tr>
								<td>
				...
				<div id="s1" >Advance Filter</div>
					...
					<tr>
						<td align="left">No of Backlogs</td>
							<td>
								<!--<h4>Upto<h4>-->
