                ...
                <td colspan="2" class="col-xs-6">
                    <div style="background-color: white; color: #868686;">
                        ...
                        <div style="padding: 5px;">
                            <table align="center">
                                <?php $url="Training-edit_operations.php?year=".$year?>
                                <form method="post"  action="<?php echo "$url";?>">
								                  ...
								                  <label class="col-xs-12"><div class="col-xs-6">Year of Passing:</div><input class="col-xs-6" type="text" placeholder="YOP" name="year" required/></label>
								                  <label class="col-xs-12"><div class="col-xs-6">From-Date:</div><input class="col-xs-6" type="date" name="from-date" required/></label>
								                  <label class="col-xs-12"><div class="col-xs-6">To-Date: </div><input class="col-xs-6" type="date" name="to-date" required/></label>
								                  <label class="col-xs-12"><div class="col-xs-6">Name of the Programme:</div><input class="col-xs-6" type="text" placeholder="Name of the programme" name="programme" required/></label>
