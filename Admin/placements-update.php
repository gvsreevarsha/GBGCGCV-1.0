...
if($link === false){
    ...
    $sql = "SELECT * FROM `placements_dash` WHERE `SNo`=".$s;
                ...
                <td colspan="2" class="col-xs-6">
                    <div style="background-color: white; color: #868686;">
                        ...
                        <div style="padding: 5px;">
                            <table align="center">
                                <?php $url="placements-update_operations.php?year=".$year."&SNo=".$s;?>
                                <form method="post"  action="<?php echo "$url";?>">
                                  ...
                                  <label  class="col-xs-12"><div class="col-xs-6">Date: </div><input class="col-xs-6" type="date" name="date" value="<?php echo $row["Date"];?>" required/></label>
                                  <label  class="col-xs-12"><div class="col-xs-6">Name of the Company: </div><input class="col-xs-6" type="text" value="<?php echo $row["Company_name"];?>" name="company" required/></label>
                                  <label  class="col-xs-12"><div class="col-xs-6">CTC: </div><input class="col-xs-6" type="text" value="<?php echo $row["CTC"];?>" name="ctc" required/></label>
