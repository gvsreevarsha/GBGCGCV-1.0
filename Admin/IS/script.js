...
dial = new Dial(containers[1]);
dial.animateStart();
dial = new Dial(containers[2]);
dial.animateStart();
dial = new Dial(containers[3]);
dial.animateStart();
dial = new Dial(containers[4]);
dial.animateStart();
dial = new Dial(containers[5]);
dial.animateStart();
dial = new Dial(containers[6]);
dial.animateStart();
dial = new Dial(containers[7]);
dial.animateStart();
dial = new Dial(containers[8]);
dial.animateStart();
