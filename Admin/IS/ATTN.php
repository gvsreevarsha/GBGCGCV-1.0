...
<div align="center">
  ...
  <div class="col-sm-12 p-3" align="center" style="border-radius:10px; background-color:white; color: #868686;width:97%;">
    ...
    <table border="1">
		<tr>
			<td>SST</td>
			<td><input type="text" name="asst1" value="<?php echo $s1; ?>"</td>
			<td><input type="text" name="asst2" value="<?php echo $s2; ?>"</td>
			<td></td>
			<td></td>
			<td></td>
		...
		<tr style="background-color:white;">
			<td>TT</td>
			<td><input type="text" name="att1" value="<?php echo $t1; ?>"</td>
			<td><input type="text" name="att2" value="<?php echo $t2; ?>"</td>
			<td><input type="text" name="att3" value="<?php echo $t3; ?>"</td>
			<td><input type="text" name="att4" value="<?php echo $t4; ?>"</td>
			<td><input type="text" name="att5" value="<?php echo $t5; ?>"</td>

		</tr>
		<tr>
			<td>DT</td>
			<td><input type="text" name="acrt1" value="<?php echo $c1; ?>"</td>
			<td><input type="text" name="acrt2" value="<?php echo $c2; ?>"</td>
			<td><input type="text" name="acrt3" value="<?php echo $c3; ?>"</td>
			<td></td>
			<td></td>
