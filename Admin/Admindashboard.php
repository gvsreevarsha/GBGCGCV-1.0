...
document.forms["myform"].submit();
  ...
  <div class="row">
    ...
    <div class="col-xs-6 col-md-10 p-3 back">
        <form id="myform" class="dropdown" method="post" action="Admindashboard.php" onchange="submitform()">
        ...
        <table class="col-xs-12 p-3" valign="center">
            ...
            <tr>
                <td colspan="2" class="col-xs-6">
                    <div class="runningtext">
                        <div>&nbsp;</div>
                        <div align="center" class="subheading">Notice Board-Training&nbsp;<button class="btn btn-blue"><?php $url="training-display_edit.php?year=".$year?><a class="nodec" href="<?php echo "$url";?>">Edit</a></button></div>
                        <div>&nbsp;</div>
                        <div>
                            <table align="center">
                                <?php
...
echo '<table width="100%"" align="center">
      <tr class="notice-top">
          ...
          <td> <font face="Arial">&nbsp;Name of the Programme</font> </td>
...
if ($result = $mysqli->query($query)) {
    while ($row = $result->fetch_assoc()) {
        ...
        if($row["from_date"]>$date)
          ...
          $status="Completed";
        echo '<tr class="notice dash">
                  <td>'.$row["from_date"].'</td>
                  <td>'.$row["to_date"].'</td>
                  <td align="left">&nbsp;'.$row["name_of_the_program"].'</td>
    ...
    $result->free();
                ...
                <td colspan="2" class="col-xs-6">
                    <div class="runningtext">
                        <div>&nbsp;</div>
                        <div align="center" class="subheading">Notice Board-Placement&nbsp;<button class="btn btn-blue"><?php $url="placements-display_edit.php?year=".$year?><a href="<?php echo "$url";?>" class="nodec">Edit</a></button></div>
                        <div>&nbsp;</div>
                        <div>
                            <table align="center">
                                <?php
...
echo '<table width="100%" align="center">
      <tr class="notice-top">
          ...
          <td> <font face="Arial">CTC</font> </td>
      </tr>';
