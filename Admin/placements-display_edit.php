            ...
            <tr>
                <td colspan="2" class="col-xs-6">
                    <div style="background-color: white; color: #868686;">
                        <div>&nbsp;</div>
                        <div align="center" style="color: black">Notice Board-Placement&nbsp;<button><a style="color: #2B3E4D;" href="placements-add.php" class="glyphicon glyphicon-plus p-2" name="Add"></a></button></div>
                        <div>&nbsp;</div>
