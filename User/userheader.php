  ...
  <div class="container-fluid" style="background-color:#303030;">
    <div class="row" style="background-color">
      <div class="col-sm-1 p-4" background="white" height="200px">
          <img  src="Images/gitam_logo.jpg" width="100px" height="100px" style="padding: 5px; background-color:#303030;">
      </div>
      <div class="col-sm-2">
      	<div>&nbsp;</div>
      	<div>&nbsp;</div>
      ...
      <div class="col-sm-6 col-sm-offset-1" align="right">
	      ...
	      <li class="col-sm-3"><a href="changepass.php" style="color: lightgreen;">Change Password</a></li>
