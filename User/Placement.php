...
mysqli_select_db($con, 'gcgc');
    ...
    $sql6="SELECT count(PIU) AS total6 FROM cdt2020 WHERE PIU='Y' AND userid='$usn'";
...
<?php
              $query = "select * from cdt2020 c,companies p where p.company_id=c.cid and c.userid='$usn'  and c.attendance='P'" ;
 ...
 ?>
                    ...
                    <tr>
                        ...
                        <td style= "text-align:center" ><img src="<?php echo $row['company_logo'];?>" alt ="Logo unavailable" style="width: 100px; height: 100px"></td>
